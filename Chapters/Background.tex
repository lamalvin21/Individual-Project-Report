...
\chapter{Background}
First, background of the project is discussed and suitable explanations provide context for the entire project. The broad scope of the project is presented before going into project-specific details in the context section.
...
\textit{Figure 2.2} describes the men's football team: Arsenal. Arteta is the manager of Arsenal and Arsenal's captain is Ødegaard. Arteta (the manager) also selects the captain. The year Arsenal was founded is depicted in the graph as 1886.

...
Assess speed of query for generating the knowledge graph to ensure expansion of the knowledge graph is possible in the future without encountering severe time constraints. This will measure scalability based on many different factors (more detail in the evaluation chapter). 
\hline

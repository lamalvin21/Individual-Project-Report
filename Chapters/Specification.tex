...
Organ ontology created will match data from the given dataset and only relevant segments of the provided ontology will be included. Extracting the relevant parts of the ontology ensures the correct types are defined and certifies all classes are correctly converted to guarantee the generation of a valid knowledge graph. Ensure all relationships are accounted for and the ontology is concise with no redundant details. \\
\hline

...
\begin{enumerate}
  ...
  \item \textbf{'Clean \& Refine data' node} involves two pathways to account for the data with no external links, which skips the steps involving them. % re-write
  ...
  \item \textbf{'Add to knowledge graph' node} adds both clean and refined data from node 3 as well as external links to the knowledge graph.  % re-write
